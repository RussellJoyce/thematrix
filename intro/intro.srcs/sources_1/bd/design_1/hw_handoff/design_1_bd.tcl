...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set gpio2_io_o [ create_bd_port -dir O -from 5 -to 0 gpio2_io_o ]
  set gpio_io_o [ create_bd_port -dir O -from 6 -to 0 gpio_io_o ]
...
CONFIG.NUM_MI {3} \
  ...
  connect_bd_net -net axi_gpio_2_gpio2_io_o [get_bd_ports gpio2_io_o] [get_bd_pins axi_gpio_2/gpio2_io_o]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_ports gpio_io_o] [get_bd_pins axi_gpio_2/gpio_io_o]
...
preplace portBus gpio2_io_o -pg 1 -y 360 -defaultsOSRD
preplace portBus gpio_io_o -pg 1 -y 340 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 1 -y 190 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -y 70 -defaultsOSRD
preplace inst axi_gpio_1 -pg 1 -lvl 3 -y 200 -defaultsOSRD
preplace inst axi_gpio_2 -pg 1 -lvl 3 -y 350 -defaultsOSRD
...
preplace netloc processing_system7_0_DDR 1 1 3 NJ 340 NJ 430 NJ
...
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 -30 100 380
preplace netloc axi_gpio_2_gpio_io_o 1 3 1 N
preplace netloc processing_system7_0_axi_periph_M02_AXI 1 2 1 750
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 2 420 20 740
preplace netloc axi_gpio_0_GPIO2 1 3 1 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 360 NJ 440 NJ
preplace netloc axi_gpio_2_gpio2_io_o 1 3 1 1050
preplace netloc axi_gpio_0_GPIO 1 3 1 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 1 410
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 -20 290 390 10 760
preplace netloc axi_gpio_1_GPIO 1 3 1 NJ
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 2 1 N
levelinfo -pg 1 -50 180 570 900 1080 -top 0 -bot 570
",
}
