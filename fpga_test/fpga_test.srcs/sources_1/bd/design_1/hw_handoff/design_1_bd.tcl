...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set PMOD_A0 [ create_bd_port -dir O PMOD_A0 ]
  set PMOD_A1 [ create_bd_port -dir O PMOD_A1 ]
  set PMOD_A2 [ create_bd_port -dir O PMOD_A2 ]
  set PMOD_A3 [ create_bd_port -dir O PMOD_A3 ]
  set PMOD_B0 [ create_bd_port -dir O PMOD_B0 ]
  set PMOD_B1 [ create_bd_port -dir O PMOD_B1 ]
  set PMOD_BLANK [ create_bd_port -dir O PMOD_BLANK ]
  set PMOD_CLK [ create_bd_port -dir O PMOD_CLK ]
  set PMOD_G0 [ create_bd_port -dir O PMOD_G0 ]
  set PMOD_G1 [ create_bd_port -dir O PMOD_G1 ]
  set PMOD_LATCH [ create_bd_port -dir O PMOD_LATCH ]
  set PMOD_R0 [ create_bd_port -dir O PMOD_R0 ]
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_net -net panel_test_0_PMOD_A3 [get_bd_ports PMOD_A3] [get_bd_pins panel_test_0/PMOD_A3]
  connect_bd_net -net panel_test_0_PMOD_B0 [get_bd_ports PMOD_B0] [get_bd_pins panel_test_0/PMOD_B0]
  connect_bd_net -net panel_test_0_PMOD_B1 [get_bd_ports PMOD_B1] [get_bd_pins panel_test_0/PMOD_B1]
  connect_bd_net -net panel_test_0_PMOD_BLANK [get_bd_ports PMOD_BLANK] [get_bd_pins panel_test_0/PMOD_BLANK]
  connect_bd_net -net panel_test_0_PMOD_CLK [get_bd_ports PMOD_CLK] [get_bd_pins panel_test_0/PMOD_CLK]
  connect_bd_net -net panel_test_0_PMOD_G0 [get_bd_ports PMOD_G0] [get_bd_pins panel_test_0/PMOD_G0]
  connect_bd_net -net panel_test_0_PMOD_G1 [get_bd_ports PMOD_G1] [get_bd_pins panel_test_0/PMOD_G1]
  connect_bd_net -net panel_test_0_PMOD_LATCH [get_bd_ports PMOD_LATCH] [get_bd_pins panel_test_0/PMOD_LATCH]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins panel_test_0/clk50_in] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
...
preplace port PMOD_LATCH -pg 1 -y 360 -defaultsOSRD
preplace port PMOD_B0 -pg 1 -y 180 -defaultsOSRD
preplace port PMOD_B1 -pg 1 -y 240 -defaultsOSRD
preplace port PMOD_G0 -pg 1 -y 160 -defaultsOSRD
preplace port PMOD_CLK -pg 1 -y 380 -defaultsOSRD
preplace port PMOD_A0 -pg 1 -y 260 -defaultsOSRD
preplace port PMOD_G1 -pg 1 -y 220 -defaultsOSRD
preplace port PMOD_A1 -pg 1 -y 280 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 70 -defaultsOSRD
preplace port PMOD_A2 -pg 1 -y 300 -defaultsOSRD
preplace port PMOD_R0 -pg 1 -y 140 -defaultsOSRD
preplace port PMOD_BLANK -pg 1 -y 340 -defaultsOSRD
...
levelinfo -pg 1 0 220 530 650 -top 0 -bot 430
",
}
